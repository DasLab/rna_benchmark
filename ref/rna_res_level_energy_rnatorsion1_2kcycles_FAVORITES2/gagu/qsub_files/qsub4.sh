...
/home/rhiju/src/rosetta//main/source/bin/stepwise -s gagu_HELIX1.pdb gagu_HELIX2.pdb -fasta gagu.fasta -terminal_res A:2 A:9 B:13 B:20 -extra_min_res A:3 A:8 B:14 B:19 -superimpose_over_all -cycles 200 -nstruct 20 -intermolecular_frequency 0.0 -save_times -native gagu_2lx1_RNA.pdb -score:rna_torsion_potential RNA11_based_new -chemical::enlarge_H_lj -set_weights rna_torsion 1.0 -cycles 2000 -out:file:silent SWM/4/swm_rebuild.out > /dev/null 2> /dev/null 
