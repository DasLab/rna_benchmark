...
/home/rhiju/src/rosetta//main/source/bin/stepwise -s gagu_forcesyn_HELIX1.pdb gagu_forcesyn_HELIX2.pdb -fasta gagu_forcesyn.fasta -terminal_res A:2 A:9 B:13 B:20 -extra_min_res A:3 A:8 B:14 B:19 -superimpose_over_all -cycles 200 -nstruct 20 -intermolecular_frequency 0.0 -save_times -native gagu_forcesyn_2lx1_RNA.pdb -force_syn_chi_res_list A:4 A:6 B:15 B:17 -score:rna_torsion_potential RNA11_based_new -chemical::enlarge_H_lj -set_weights rna_torsion 1.0 -cycles 2000 -out:file:silent SWM/0/swm_rebuild.out > /dev/null 2> /dev/null 
